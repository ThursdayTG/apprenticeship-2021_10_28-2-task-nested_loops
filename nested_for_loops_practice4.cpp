...
int main(){
	...
	/*
	 * Aufgabe 4 (gleichschenkliges / rechtwinkliges Dreieck)
	 *
	 * #####
	 * ####
	 * ###
...
/*
	compile:
g++ nested_for_loops_practice4.cpp -o nested_for_loops_practice4

	run from console:
./nested_for_loops_practice4

	clear, compile, run:
clear && g++ nested_for_loops_practice4.cpp -o nested_for_loops_practice4 && ./nested_for_loops_practice4
