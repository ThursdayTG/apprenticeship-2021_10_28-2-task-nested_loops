...
/*
	compile:
g++ nested_for_loops_practice8.cpp -o nested_for_loops_practice8

	run from console:
./nested_for_loops_practice8

	clear, compile, run:
clear && g++ nested_for_loops_practice8.cpp -o nested_for_loops_practice8 && ./nested_for_loops_practice8
